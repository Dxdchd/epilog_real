...
public class FriendCalanderListAdapter extends RecyclerView.Adapter<FriendCalanderListAdapter.MonthView> {
    ...
    public FriendCalanderListAdapter(String nickname, String uid) {
    ...
    public void onBindViewHolder(MonthView holder, int position) {
        ...
        FriendCalanderDayAdapter dayListAdapter = new FriendCalanderDayAdapter(tempMonth, dayList, holder.layout, nickname, uid);
