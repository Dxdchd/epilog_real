...
public class FriendCalanderDayAdapter extends RecyclerView.Adapter<FriendCalanderDayAdapter.DayView> {
    ...
    public FriendCalanderDayAdapter(int tempMonth, List<Date> dayList, View view, String nickname, String uid) {
    ...
    public void onBindViewHolder(DayView holder, int position) {
        Log.d("uidda", "onBindViewHolder: "+uid+nickname);
        DocumentReference documentReference = db.collection("diary").document(uid + "_" + sdf.format(dayList.get(position)));
